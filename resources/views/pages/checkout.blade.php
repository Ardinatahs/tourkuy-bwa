        ...
        <section class="section-details-content">
            ...
            <div class="row">
                ...
                <div class="card card-details">
                    ...
                    <h1>Who is Going?</h1>
                    <p>
                        Trip to {{ $item-> travel_package -> title}}, Trip to {{ $item-> travel_package -> location}}
                    </p>
                    <div class="attendee">
                    ...
                    <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                        ...
                        <input type="text" class="form-control datepicker" name="doe_passport" style="width: 120px" id="doe_passport" placeholder="DOE Passport" />
                        </div>

                        <button type="submit" class="btn btn-add-now mb-2 px-4">Add Now</button>
                    </form>
                    <h3 class="mt-2 mb-0">Note</h3>
                    <p class="disclaimer mb-0">You are only able to invite member that has registered in Tourkuy.</p>
                    </div>
                </div>
                </div>
                <div class="col-lg-4">
                <div class="card card-details card-right">
                    ...
                    <p class="payment-instructions">Please complete the payment before you continue the wonderful trip</p>
                    <div class="bank">
                    <div class="bank-item pb-3 pt-2">
