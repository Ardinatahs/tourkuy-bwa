        ...
        <div class="col-sm-6 col-md-6 col-lg-4">
          <div class="card card-testimonial text-center">
            <div class="testimonial-content">
              ...
              <h3 class="mb-4">Ardi</h3>
              <p class="testimonial">" It was glorious and i could not to stop to say wohoo for every single moment Dankeeeeeee "</p>
            </div>
            <hr />
        ...
        <div class="col-sm-6 col-md-6 col-lg-4">
          <div class="card card-testimonial text-center">
            <div class="testimonial-content">
              ...
              <p class="testimonial">" This is my beautiful trip and I can enjoy this trip "</p>
            </div>
            <hr />
        ...
        <div class="col-sm-6 col-md-6 col-lg-4">
          <div class="card card-testimonial text-center">
            <div class="testimonial-content">
              ...
              <h3 class="mb-4">Gustave Flaubert</h3>
              <p class="testimonial">" Travel makes one modest. You see what a tiny place you occupy in the world "</p>
            </div>
            <hr />
            <p class="trip-to mt-2">Trip to Raja Ampat, Indonesia</p>
          </div>
        </div>
      </div>
      <div class="row">
